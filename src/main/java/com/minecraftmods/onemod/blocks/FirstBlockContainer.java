...
import static com.minecraftmods.onemod.blocks.ObjectHolders.FIRST_BLOCK_CONTAINER;

/** @author Mshnik */
final class FirstBlockContainer extends Container {
  private static final int GUI_GRID_SIZE_PX = 18;

  private final TileEntity tileEntity;
  private final IItemHandler playerInventoryHandler;

  FirstBlockContainer(int id, World world, BlockPos pos, PlayerInventory playerInventory) {
    super(FIRST_BLOCK_CONTAINER, id);
